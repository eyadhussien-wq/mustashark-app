...
psql(`CREATE TABLE e02_seam_quotes (id text primary key, client_id text not null, currency text not null, status text not null); CREATE TABLE e02_seam_milestones (id text primary key, quote_id text not null references e02_seam_quotes(id), amount numeric(14,2) not null, status text not null); CREATE TABLE e02_seam_escrow (id text primary key, quote_id text not null references e02_seam_quotes(id), deposited numeric(14,2) not null, allocated numeric(14,2) not null, refunded numeric(14,2) not null); CREATE TABLE e02_seam_tx (id text primary key, escrow_id text not null references e02_seam_escrow(id), milestone_id text not null references e02_seam_milestones(id), type text not null, amount numeric(14,2) not null, currency text not null, client_id text not null); INSERT INTO e02_seam_quotes VALUES ('qA','A','JOD','active'),('qB','B','JOD','active'); INSERT INTO e02_seam_milestones VALUES ('mA','qA',100,'funded'),('mB','qB',100,'funded'); INSERT INTO e02_seam_escrow VALUES ('eA','qA',150,0,0),('eB','qB',150,0,0);`);
