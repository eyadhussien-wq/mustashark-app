...
import { listUpcomingBookings } from "../controllers/upcomingBookings";
...
bookingsRouter.get("/bookings/upcoming", requireAuth, requireClientLawyerOrAdmin, listUpcomingBookings);
