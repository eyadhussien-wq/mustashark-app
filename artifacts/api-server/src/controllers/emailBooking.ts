...
/**
 * Email consultations deliberately use the same server-side pricing and
 * authentication rules as normal bookings, but live in a dedicated endpoint
 * so the existing security-sensitive bookings controller is not rewritten.
 */
