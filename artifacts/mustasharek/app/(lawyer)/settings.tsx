...
type LawyerCommunicationChannels = CommunicationChannels & { email: boolean };
...
const styles = StyleSheet.create({
  ...
  dayChip: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, borderWidth: 1.5, borderColor: C.border, backgroundColor: C.card },
